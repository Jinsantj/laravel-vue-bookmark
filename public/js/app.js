...
/* harmony import */ var _api_Csrf__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../api/Csrf */ "./resources/js/api/Csrf.js");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    onSubmit: function onSubmit() {
      ...
      _api_Csrf__WEBPACK_IMPORTED_MODULE_0__["default"].getCookie().then(function (response) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    register: function register() {
      ...
      _api_Csrf__WEBPACK_IMPORTED_MODULE_0__["default"].getCookie().then(function () {
        _this.form.post('api/register').then(function (response) {
          window.location.href = '/';
        });
      });
    }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    onSubmit: function onSubmit() {
      ...
      this.isLoading = true;
      this.form.post('api/categories').then(function (cat) {
        return _this.onAdded(cat);
      })["catch"](function (err) {
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/AddUrl.vue?vue&type=script&lang=js&":
/*!*****************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/AddUrl.vue?vue&type=script&lang=js& ***!
  \*****************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  watch: {
    categories: function categories() {
      ...
      _models_category__WEBPACK_IMPORTED_MODULE_0__["default"].all(function (categories) {
  ...
  methods: {
    onSubmit: function onSubmit() {
      ...
      this.isLoading = true;
      this.form.post('api/urls').then(function (url) {
        _this3.onAdded(url);
      })["catch"](function (errors) {
        _this3.failed(errors);
      });
    },
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    _models_user__WEBPACK_IMPORTED_MODULE_0__["default"].show(function (user) {
      return _this.user = user;
    });
  },
  methods: {
    topnavModal: function topnavModal() {
    ...
    modalDisable: function modalDisable() {
      this.isTopnavModal ? this.isTopnavModal = false : false;
      this.isWindowHalt = false;
    },
    logoutUser: function logoutUser() {
      this.logout.post('api/logout').then(function (response) {
        window.location.href = '/';
      });
    },
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  filters: {
    ...
    trimDescription: function trimDescription(string) {
  ...
  computed: {
    allurls: function allurls() {
      ...
      if (this.search) {
        return this.urls.filter(function (item) {
  ...
  methods: {
    updatePage: function updatePage(id) {
      ...
      axios.get('/api/urls/category/' + id).then(function (urls) {
        return _this2.urls = urls.data;
      });
      axios.get('/api/categories/' + id).then(function (category) {
        _this2.editCategory.name = category.data.name;
      });
    },
    updateCategory: function updateCategory() {
      var _this3 = this;

      this.editCategory.put('api/categories/' + this.id).then(function (response) {
        _this3.$parent.$emit('updatedSuccess');

        _this3.inactiveField();
      });
    },
    ...
    inactiveField: function inactiveField() {
      this.isChecked = true ? this.isChecked = false : undefined;
      this.isWindowHalt = true ? this.isWindowHalt = false : undefined;
    },
    remove: function remove(url) {
      var _this4 = this;

      this.form["delete"]('/api/urls/' + url).then(function (url) {
        _this4.onRemoved(url);
      })["catch"](function (errors) {
        return console.log(errors);
      });
    },
    onRemoved: function onRemoved(url) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_AddUrl_vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/AddUrl.vue */ "./resources/js/components/AddUrl.vue");
/* harmony import */ var _models_url__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../models/url */ "./resources/js/models/url.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    AddUrl: _components_AddUrl_vue__WEBPACK_IMPORTED_MODULE_0__["default"],
  ...
  watch: {
    ...
    urls: function urls() {
      ...
      this.urls.map(function (val, index) {
        if (!_this2.urls[index].checked && !_this2.urls[index].form) {
          _this2.$set(_this2.urls[index], "checked", false), _this2.$set(_this2.urls[index], "form", new Form({
            name: _this2.urls[index].name,
            description: _this2.urls[index].description
          }));
        }
      });
    }
  ...
  created: function created() {
    ...
    _models_url__WEBPACK_IMPORTED_MODULE_1__["default"].all(function (urls) {
      _this3.urls = urls, _this3.urls.map(function (val, index) {
        _this3.$set(_this3.urls[index], "checked", false), _this3.$set(_this3.urls[index], "form", new Form({
          name: _this3.urls[index].name,
          description: _this3.urls[index].description
        }));
      });
    });
    this.allurls == '' ? this.empty = true : this.empty = false;
  ...
  methods: {
    update: function update(url) {
      ...
      this.urls.map(function (val, index) {
        if (_this4.urls[index].checked == true) {
          _this4.urls[index].form.put('api/urls/' + url).then(function (url) {
            _this4.urls[index].checked = false;
            _this4.urls[index].name = _this4.urls[index].form.name;
          });
        }
      });
    },
    fieldInactive: function fieldInactive() {
      var _this5 = this;

      this.urls.map(function (val, index) {
        _this5.urls[index].checked = false;
      });
      this.isWindowHalt = false;
    },
    fieldActive: function fieldActive(id) {
      var _this6 = this;

      this.urls.map(function (val, index) {
        _this6.urls[index].checked = false;
      });
      this.urls.map(function (url) {
        var currentIndex = _this6.urls.findIndex(function (index) {
          return index.id == id;
        });

        _this6.urls[currentIndex].checked = true;
      });
      this.isWindowHalt = true;
    },
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _models_category__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../models/category */ "./resources/js/models/category.js");
/* harmony import */ var _components_AddCategory__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/AddCategory */ "./resources/js/components/AddCategory.vue");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    AddCategory: _components_AddCategory__WEBPACK_IMPORTED_MODULE_1__["default"]
  },
  name: 'app',
  data: function data() {
    return {
  ...
  mounted: function mounted() {
    ...
    document.querySelector('.navbar-item').addEventListener('click', function () {
      _this3.isSidebarActive = false;
      console.log('closed');
    });
  },
  methods: {
    reload: function reload(category) {
    ...
    remove: function remove(category) {
      ...
      this.form["delete"]('/api/categories/' + category).then(function (category) {
        _this4.onRemoved(category);
      });
    },
    onRemoved: function onRemoved(category) {
    ...
    sidebarHide: function sidebarHide() {
...
/***/ "./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/AddCategory.vue?vue&type=style&index=0&lang=css&":
/*!*****************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader??ref--6-1!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--6-2!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/AddCategory.vue?vue&type=style&index=0&lang=css& ***!
  \*****************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/AddUrl.vue?vue&type=style&index=0&lang=css&":
/*!************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader??ref--6-1!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--6-2!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/AddUrl.vue?vue&type=style&index=0&lang=css& ***!
  \************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/views/Category.vue?vue&type=style&index=0&id=6480121d&scoped=true&lang=css&":
/*!*********************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader??ref--6-1!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--6-2!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/views/Category.vue?vue&type=style&index=0&id=6480121d&scoped=true&lang=css& ***!
  \*********************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/style-loader/index.js!./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/AddCategory.vue?vue&type=style&index=0&lang=css&":
/*!*********************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/style-loader!./node_modules/css-loader??ref--6-1!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--6-2!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/AddCategory.vue?vue&type=style&index=0&lang=css& ***!
  \*********************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {


var content = __webpack_require__(/*! !../../../node_modules/css-loader??ref--6-1!../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../node_modules/postcss-loader/src??ref--6-2!../../../node_modules/vue-loader/lib??vue-loader-options!./AddCategory.vue?vue&type=style&index=0&lang=css& */ "./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/AddCategory.vue?vue&type=style&index=0&lang=css&");
...
/***/ "./node_modules/style-loader/index.js!./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/AddUrl.vue?vue&type=style&index=0&lang=css&":
/*!****************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/style-loader!./node_modules/css-loader??ref--6-1!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--6-2!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/AddUrl.vue?vue&type=style&index=0&lang=css& ***!
  \****************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {


var content = __webpack_require__(/*! !../../../node_modules/css-loader??ref--6-1!../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../node_modules/postcss-loader/src??ref--6-2!../../../node_modules/vue-loader/lib??vue-loader-options!./AddUrl.vue?vue&type=style&index=0&lang=css& */ "./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/AddUrl.vue?vue&type=style&index=0&lang=css&");
...
/***/ "./node_modules/style-loader/index.js!./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/views/Category.vue?vue&type=style&index=0&id=6480121d&scoped=true&lang=css&":
/*!*************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/style-loader!./node_modules/css-loader??ref--6-1!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--6-2!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/views/Category.vue?vue&type=style&index=0&id=6480121d&scoped=true&lang=css& ***!
  \*************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {


var content = __webpack_require__(/*! !../../../node_modules/css-loader??ref--6-1!../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../node_modules/postcss-loader/src??ref--6-2!../../../node_modules/vue-loader/lib??vue-loader-options!./Category.vue?vue&type=style&index=0&id=6480121d&scoped=true&lang=css& */ "./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/views/Category.vue?vue&type=style&index=0&id=6480121d&scoped=true&lang=css&");
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/auth/login.vue?vue&type=template&id=74bbc780&":
/*!**************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/auth/login.vue?vue&type=template&id=74bbc780& ***!
  \**************************************************************************************************************************************************************************************************/
...
var render = function() {
  ...
  return _c("div", { staticClass: "loginContainer" }, [
      ...
      _c(
        ...
        [
          _c("div", { staticClass: "control" }, [
            _c("label", [_vm._v("E-Mail or Username")]),
            _vm._v(" "),
            _c("input", {
              directives: [
                {
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "login-header" }, [
      _c("h6", [_vm._v("Welcome Back")]),
      _vm._v(" "),
      _c("h1", [_vm._v("Log into your account")])
    ])
  },
  function() {
    var _vm = this
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "control-password" }, [
  ...
  function() {
    ...
    return _c("div", { staticClass: "login-footer" }, [
      _c("a", { attrs: { href: "/create-new-account" } }, [
        _vm._v("Not registered yet? Register "),
...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c("div", { staticClass: "control" }, [
      _c(
        "button",
        { staticClass: "btn btn-login", attrs: { type: "submit" } },
        [_vm._v("Register")]
      )
    ])
  },
  function() {
    ...
    return _c("div", { staticClass: "login-footer" }, [
      _c("p", [
        _vm._v("By signing in, you agree to the "),
...
var render = function() {
  ...
  return _c("div", [
    _c("div", [
      _c(
        "div",
        { class: { active: _vm.active }, staticStyle: { display: "none" } },
        [
          _c(
            "form",
            {
              staticClass: "container form-category",
              attrs: { method: "POST", action: "/urls" },
              on: {
                submit: function($event) {
                  $event.preventDefault()
                  return _vm.onSubmit($event)
            ...
            [
              ...
              _c(
                "div",
                { staticClass: "field", class: { loading: _vm.loading } },
                [
                  _c("div", { staticClass: "control" }, [
                    _c(
                      "button",
    ...
    _c(
      "div",
      {
        staticClass: "collection-container addCategory",
        class: { activeButton: _vm.activeButton }
      },
      [
        _c("i", {
        ...
        _vm._v(" "),
        _c("label", [_vm._v("New Collection")])
      ]
    ),
    _vm._v(" "),
    _c(
      "div",
      { class: { loading: _vm.isLoading }, staticStyle: { display: "none" } },
      [_vm._m(0)]
    )
  ])
}
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "Loader__container" }, [
      _c("div", { staticClass: "Loader__item" }),
      _vm._v(" "),
      _c("div", { staticClass: "Loader__item" }),
      _vm._v(" "),
      _c("div", { staticClass: "Loader__item" }),
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/AddUrl.vue?vue&type=template&id=3bcf078e&":
/*!*********************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/AddUrl.vue?vue&type=template&id=3bcf078e& ***!
  \*********************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "addUrl" }, [
    _c(
      "div",
      { class: { active: _vm.active }, staticStyle: { display: "none" } },
      [
                  ...
                  "button",
                  {
                    ...
                    on: {
                      click: function($event) {
                        $event.preventDefault()
                        return _vm.toggleCollection($event)
                      }
                    }
                  },
    ...
    _c(
      ...
      [
        _c("i", {
          staticClass: "fas fa-plus",
          on: { click: _vm.toggleCollection }
        }),
        _vm._v(" "),
        _c("label", [_vm._v("New Bookmark")])
      ]
    ),
    _vm._v(" "),
    this.isEmptyCategory
      ? _c("p", { staticClass: "emptyCategoryLabel" }, [
          _vm._v("Lets begin by creating a new collection.")
        ])
      : _vm._e(),
    _vm._v(" "),
    this.isFailed
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "modal-content" }, [
      _c("h1", [_vm._v("An Error Occcurred")]),
      _vm._v(" "),
      _c("ul", [
        _c("li", [
          _vm._v("Check whether there is an active internet connectivity")
        ]),
        _vm._v(" "),
        _c("li", [_vm._v("Check whether the url entered is an valid one")])
      ])
    ])
  },
  function() {
...
var render = function() {
  ...
  return _c("div", [
    this.isWindowHalt
      ? _c("div", {
          staticClass: "window-event freeze",
          on: { click: _vm.modalDisable }
        })
      : _vm._e(),
    _vm._v(" "),
    _c("div", { staticClass: "topnav" }, [
      _c("i", {
        ...
        on: { click: _vm.sidebarCollapse }
      }),
      _vm._v(" "),
      _c("div", { staticClass: "topnavItem" }, [
        _c("div", { staticClass: "item", on: { click: _vm.topnavModal } }, [
    ...
    _vm._v(" "),
    _vm.isTopnavModal
      ? _c("div", { staticClass: "topnavModal" }, [
...
var render = function() {
  ...
  return _c(
    ...
    { staticClass: "home" },
    [
      _c("nav-bar", { on: { sidebarActive: _vm.sidebarCollapse } }),
      _vm._v(" "),
      _c("div", { staticClass: "all-content" }, [
        this.isWindowHalt
          ? _c("div", {
              staticClass: "window-event halt",
              on: { click: _vm.inactiveField }
            })
          : _vm._e(),
        _vm._v(" "),
        _c(
          ...
          [
            _c("div", { staticClass: "wrapper" }, [
              _c("input", {
                ...
                staticClass: " input category-heading",
                class: { inputActive: _vm.isChecked },
                attrs: { type: "text", name: "name", readonly: !_vm.isChecked },
                domProps: { value: _vm.editCategory.name },
                on: {
                  dblclick: _vm.activeField,
                  input: function($event) {
                    if ($event.target.composing) {
                      return
                    }
                    _vm.$set(_vm.editCategory, "name", $event.target.value)
                  }
                }
              }),
              _vm._v(" "),
              _c("div", { staticClass: "category-underline" }),
              _vm._v(" "),
              _vm.editCategory.errors.has("name")
                ? _c("p", {
                    staticClass: "help is-danger",
                    domProps: {
                      textContent: _vm._s(_vm.editCategory.errors.get("name"))
                    }
                  })
                : _vm._e()
            ]),
        ...
        _c(
          "div",
          { staticClass: "cards" },
          _vm._l(_vm.allurls, function(url) {
            return _c("div", { key: url.id, staticClass: "cards-item" }, [
              _c(
                "a",
                {
                  attrs: {
                ...
                [
                  _c("div", { staticClass: "ogImage" }, [
                    _c("img", { attrs: { src: url.ogImage, alt: "OgImage" } })
                  ])
                ]
              ),
              _vm._v(" "),
              _c("div", { staticClass: "cards-body" }, [
                ...
                _vm._v(" "),
                _c("p", [
                  _vm._v(_vm._s(_vm._f("trimDescription")(url.description)))
                ]),
                _vm._v(" "),
                _c(
                  "a",
                  ...
                  [_vm._v(_vm._s(_vm._f("trim")(url.url)))]
                )
              ])
            ])
          }),
        ...
        _vm._v(" "),
        this.isEmpty
          ? _c("div", { staticClass: "emptyPage" }, [
              _c("h1", [_vm._v("Nothing found create one !")])
            ])
          : _vm._e()
      ])
    ],
  ...
  return _c(
    ...
    [
      this.isWindowHalt
        ? _c("div", {
            staticClass: "window-event halt",
            on: { click: _vm.fieldInactive }
          })
        : _vm._e(),
      _vm._v(" "),
      _c("nav-bar", { on: { sidebarActive: _vm.sidebarCollapse } }),
      _vm._v(" "),
      _c("add-url", { on: { inserted: _vm.reload } }),
      _vm._v(" "),
      _c("div", { staticClass: "all-content" }, [
        _c("div", { staticClass: "search" }, [
          _c("input", {
        ...
        _c(
          "div",
          { staticClass: "cards" },
          _vm._l(_vm.allurls, function(url, index) {
            return _c("div", { key: index, staticClass: "cards-item" }, [
              _c(
                "a",
                {
                  attrs: {
                      ...
                      directives: [
                        {
                          ...
                          rawName: "v-model",
                          value: url.form.name,
                          expression: "url.form.name"
                        }
                      ],
                      staticClass: "input",
                      class: { inputActive: url.checked },
                      attrs: {
                        name: "name",
                        type: "text",
                        readonly: !url.checked
                      },
                      domProps: { value: url.form.name },
                      on: {
                        dblclick: function($event) {
                          return _vm.fieldActive(url.id)
                        },
                        input: function($event) {
                          if ($event.target.composing) {
                            return
                          }
                          _vm.$set(url.form, "name", $event.target.value)
                        }
                      }
                    }),
                    _vm._v(" "),
  ...
  return _c(
    ...
    [
      _c(
        ...
        {
          staticClass: "navbar",
          class: { sidebarActive: _vm.isSidebarActive }
        },
        [
          _c("add-category", { on: { insertedCat: _vm.reload } }),
          _vm._v(" "),
          _c(
            "div",
            { staticClass: "navabar-menu" },
            [
              _c(
                "router-link",
              ...
              _vm._l(_vm.categories, function(category) {
                return _c(
                  ...
                  [
                    _c("div", { on: { click: _vm.sidebarHide } }, [
                      _vm._v(
                        "\n                        " +
      ...
      _c("router-view", {
        ...
        on: {
          updatedSuccess: _vm.categories,
          sidebarActive: _vm.sidebarCollapse
        }
      })
    ],
    1
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "collections" }, [
...
/* harmony import */ var _auth_login_vue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./auth/login.vue */ "./resources/js/auth/login.vue");
/* harmony import */ var _auth_register_vue__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./auth/register.vue */ "./resources/js/auth/register.vue");
...
new Vue({
  ...
  components: {
    AppView: _views_app_vue__WEBPACK_IMPORTED_MODULE_2__["default"],
    LoginView: _auth_login_vue__WEBPACK_IMPORTED_MODULE_3__["default"],
    RegisterView: _auth_register_vue__WEBPACK_IMPORTED_MODULE_4__["default"]
  }
});
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_login_vue_vue_type_template_id_74bbc780___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib??vue-loader-options!./login.vue?vue&type=template&id=74bbc780& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/auth/login.vue?vue&type=template&id=74bbc780&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_login_vue_vue_type_template_id_74bbc780___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_login_vue_vue_type_template_id_74bbc780___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
...
/* empty/unused harmony star reexport *//* harmony import */ var _AddCategory_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./AddCategory.vue?vue&type=style&index=0&lang=css& */ "./resources/js/components/AddCategory.vue?vue&type=style&index=0&lang=css&");
...
/***/ "./resources/js/components/AddCategory.vue?vue&type=style&index=0&lang=css&":
/*!**********************************************************************************!*\
  !*** ./resources/js/components/AddCategory.vue?vue&type=style&index=0&lang=css& ***!
  \**********************************************************************************/
/*! no static exports found */
...
/***/ "./resources/js/components/AddUrl.vue":
/*!********************************************!*\
  !*** ./resources/js/components/AddUrl.vue ***!
  \********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _AddUrl_vue_vue_type_template_id_3bcf078e___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./AddUrl.vue?vue&type=template&id=3bcf078e& */ "./resources/js/components/AddUrl.vue?vue&type=template&id=3bcf078e&");
/* harmony import */ var _AddUrl_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./AddUrl.vue?vue&type=script&lang=js& */ "./resources/js/components/AddUrl.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport *//* harmony import */ var _AddUrl_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./AddUrl.vue?vue&type=style&index=0&lang=css& */ "./resources/js/components/AddUrl.vue?vue&type=style&index=0&lang=css&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  _AddUrl_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _AddUrl_vue_vue_type_template_id_3bcf078e___WEBPACK_IMPORTED_MODULE_0__["render"],
  _AddUrl_vue_vue_type_template_id_3bcf078e___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/AddUrl.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/components/AddUrl.vue?vue&type=script&lang=js&":
/*!*********************************************************************!*\
  !*** ./resources/js/components/AddUrl.vue?vue&type=script&lang=js& ***!
  \*********************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_AddUrl_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/babel-loader/lib??ref--4-0!../../../node_modules/vue-loader/lib??vue-loader-options!./AddUrl.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/AddUrl.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_AddUrl_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/components/AddUrl.vue?vue&type=style&index=0&lang=css&":
/*!*****************************************************************************!*\
  !*** ./resources/js/components/AddUrl.vue?vue&type=style&index=0&lang=css& ***!
  \*****************************************************************************/
/*! no static exports found */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_AddUrl_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/style-loader!../../../node_modules/css-loader??ref--6-1!../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../node_modules/postcss-loader/src??ref--6-2!../../../node_modules/vue-loader/lib??vue-loader-options!./AddUrl.vue?vue&type=style&index=0&lang=css& */ "./node_modules/style-loader/index.js!./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/AddUrl.vue?vue&type=style&index=0&lang=css&");
/* harmony import */ var _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_AddUrl_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_AddUrl_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_AddUrl_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_AddUrl_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));


/***/ }),

/***/ "./resources/js/components/AddUrl.vue?vue&type=template&id=3bcf078e&":
/*!***************************************************************************!*\
  !*** ./resources/js/components/AddUrl.vue?vue&type=template&id=3bcf078e& ***!
  \***************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_AddUrl_vue_vue_type_template_id_3bcf078e___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib??vue-loader-options!./AddUrl.vue?vue&type=template&id=3bcf078e& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/AddUrl.vue?vue&type=template&id=3bcf078e&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_AddUrl_vue_vue_type_template_id_3bcf078e___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_AddUrl_vue_vue_type_template_id_3bcf078e___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
...
var category = /*#__PURE__*/function () {
  ...
  _createClass(category, null, [{
    ...
    value: function all(then) {
      return Axios.get('/api/categories').then(function (_ref) {
        var data = _ref.data;
        return then(data);
      });
    }
...
var url = /*#__PURE__*/function () {
  ...
  _createClass(url, null, [{
    key: "all",
    value: function all(then) {
      return Axios.get('/api/urls').then(function (_ref) {
        var data = _ref.data;
        return then(data);
      });
    }
...
/* harmony import */ var _models_category__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./models/category */ "./resources/js/models/category.js");
...
var routes = [{
  ...
  path: '/categories/:id',
  name: 'Category',
  component: __webpack_require__(/*! ./views/Category.vue */ "./resources/js/views/Category.vue")["default"],
  props: true
}];
...
/* empty/unused harmony star reexport *//* harmony import */ var _Category_vue_vue_type_style_index_0_id_6480121d_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Category.vue?vue&type=style&index=0&id=6480121d&scoped=true&lang=css& */ "./resources/js/views/Category.vue?vue&type=style&index=0&id=6480121d&scoped=true&lang=css&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
/***/ "./resources/js/views/Category.vue?vue&type=style&index=0&id=6480121d&scoped=true&lang=css&":
/*!**************************************************************************************************!*\
  !*** ./resources/js/views/Category.vue?vue&type=style&index=0&id=6480121d&scoped=true&lang=css& ***!
  \**************************************************************************************************/
/*! no static exports found */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Category_vue_vue_type_style_index_0_id_6480121d_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/style-loader!../../../node_modules/css-loader??ref--6-1!../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../node_modules/postcss-loader/src??ref--6-2!../../../node_modules/vue-loader/lib??vue-loader-options!./Category.vue?vue&type=style&index=0&id=6480121d&scoped=true&lang=css& */ "./node_modules/style-loader/index.js!./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/views/Category.vue?vue&type=style&index=0&id=6480121d&scoped=true&lang=css&");
/* harmony import */ var _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Category_vue_vue_type_style_index_0_id_6480121d_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Category_vue_vue_type_style_index_0_id_6480121d_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Category_vue_vue_type_style_index_0_id_6480121d_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Category_vue_vue_type_style_index_0_id_6480121d_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
__webpack_require__(/*! C:\xampp\htdocs\easy-bookmark-manager\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\xampp\htdocs\easy-bookmark-manager\resources\sass\app.scss */"./resources/sass/app.scss");
